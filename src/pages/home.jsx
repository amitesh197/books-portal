        ...
        <>
            ...
            <div className="flex flex-col items-center justify-center text-black text-base  w-full">
                ...
                >
                    ...
                    queryType === "feedback" || queryType === "technicalIssue" ? (
                        <div className="flex flex-col ">
                    ...
                    {
                        queryType === "technicalIssue" && (
                            <>
                                <div className="flex flex-col ">
                                    <label className=" mx-1 font-semibold">Device Name</label>
                                    <input
                                        type="text"
                                ...
                                <div className="flex flex-col ">
                                    ...
                                    <label className=" mx-1 font-semibold">Device Specifications</label>
                                    <textarea
                    ...
                    queryType == "feedback" || queryType === "technicalIssue" ? (
                        <div className="flex flex-col ">
                            <label className="  mx-1 font-semibold">File Upload</label>
                            <input
                                type="file"
                                name="file"
                    ...
                    <div className="flex flex-col ">
                        <label className=" mx-1 font-semibold">Issue</label>
                        <textarea
