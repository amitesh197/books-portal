...
export default function History() {
  //get the last part of the url as userEmail

  const navigate = useNavigate();
  const userEmail = window.location.pathname.split("/").pop() + "@gmail.com";
  ...
  return (
    <>
      ...
      <div className=" flex items-center">
        <div
          className="inline mx-3 rounded-full border border-theme-dark px-2 py-1  hover:cursor-pointer"
          onClick={() => navigate(-1)}
        >
          <div className=" fa fa-long-arrow-left mr-2"></div>
          Back
        </div>
        <form className="m-2">
